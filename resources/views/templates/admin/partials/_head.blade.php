<head>
  ...
  <title>@if(Request::is('login')) Login - Admin
    @else
      Admin - Desa
     @endif</title>
  ...
  <!-- BEGIN: Theme CSS-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/app-assets/css/material.min.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/app-assets/css/material-extended.min.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/app-assets/css/material-colors.min.css')}}">
  <!-- END: Theme CSS-->
